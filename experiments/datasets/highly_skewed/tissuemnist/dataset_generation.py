...
missing_classes = {
        1: [2, 3, 4, 5, 7], # classes 0, 1, 6 present only
        2: [1, 3, 4, 5, 7], # classes 0, 2, 6 present only
        3: [1, 2, 4, 5, 7], # classes 0, 3, 6 present only
        4: [1, 2, 3, 5, 7], # classes 0, 4, 6 present only
        5: [1, 2, 3, 4, 7], # classes 0, 5, 6 present only
        6: [1, 2, 3, 4, 5], # classes 0, 6, 7 present only
    } # Classes 0 and 6 are shared
...
pointers_name = "TISSUEMNIST_6_dataset_pointers"
dataset_name = "TISSUEMNIST_6_dataset"
blueprint_name = "TISSUEMNIST_6_dataset_blueprint"
# Path to a directory
path = os.getcwd()
