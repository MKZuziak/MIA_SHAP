...
DATASET_PATH = r'/Users/soumia.elmestari/Desktop/save/MIA_SHAP/experiments/datasets/uniform/mnist/MNIST_8_dataset_pointers'
...
def integration_test():
    ...
    node_template = FederatedNode(dp=True,privacy_engine=privacy_engine)
